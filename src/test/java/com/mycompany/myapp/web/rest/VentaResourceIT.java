...
class VentaResourceIT {
    ...
    void createVenta() throws Exception {
        ...
        assertThat(testVenta.getIdventa()).isEqualTo(DEFAULT_IDVENTA);
        assertThat(testVenta.getCantidad()).isEqualTo(DEFAULT_CANTIDAD);
        assertThat(testVenta.getIdCliente()).isEqualTo(DEFAULT_ID_CLIENTE);
        assertThat(testVenta.getIdProducto()).isEqualTo(DEFAULT_ID_PRODUCTO);
    }
    ...
    void putNewVenta() throws Exception {
        ...
        updatedVenta.idventa(UPDATED_IDVENTA).cantidad(UPDATED_CANTIDAD).idCliente(UPDATED_ID_CLIENTE).idProducto(UPDATED_ID_PRODUCTO);
        ...
        Venta testVenta = ventaList.get(ventaList.size() - 1);
        assertThat(testVenta.getIdventa()).isEqualTo(UPDATED_IDVENTA);
        assertThat(testVenta.getCantidad()).isEqualTo(UPDATED_CANTIDAD);
        assertThat(testVenta.getIdCliente()).isEqualTo(UPDATED_ID_CLIENTE);
        assertThat(testVenta.getIdProducto()).isEqualTo(UPDATED_ID_PRODUCTO);
    }
    ...
    void partialUpdateVentaWithPatch() throws Exception {
        ...
        partialUpdatedVenta.cantidad(UPDATED_CANTIDAD).idCliente(UPDATED_ID_CLIENTE);
