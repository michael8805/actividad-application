...
class ClienteResourceIT {
    ...
    private static final Integer DEFAULT_IDCLIENTE = 1;
    private static final Integer UPDATED_IDCLIENTE = 2;
    ...
    void createCliente() throws Exception {
        ...
        assertThat(testCliente.getIdcliente()).isEqualTo(DEFAULT_IDCLIENTE);
    ...
    void putNewCliente() throws Exception {
        ...
        Cliente testCliente = clienteList.get(clienteList.size() - 1);
        assertThat(testCliente.getIdcliente()).isEqualTo(UPDATED_IDCLIENTE);
